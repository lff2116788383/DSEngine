...
layout(std140, set = 2, binding = 0) uniform PerMaterial {
    vec4 _mat_ink_color;
    vec4 _mat_paper_color;
    float _mat_hatch_density;
    float _mat_hatch_thickness;
};
#define ink_color _mat_ink_color
#define paper_color _mat_paper_color
#define hatch_density _mat_hatch_density
#define hatch_thickness _mat_hatch_thickness
