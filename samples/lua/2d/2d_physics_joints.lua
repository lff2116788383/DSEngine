...
function M.Setup(config)
    ...
    pcall(dse.ecs.add_rigid_body, anchor1, 0, 1.0, 0) -- static
    ...
    pcall(dse.ecs.add_rigid_body, anchor2, 0, 1.0, 0)
    ...
    pcall(dse.ecs.add_rigid_body, rail, 0, 1.0, 0)
    ...
    pcall(dse.ecs.add_rigid_body, ground, 0, 1.0, 0)
    pcall(dse.ecs.add_box_collider, ground, 16.0, 1.0, 1.0, 0.4, 0.1)
end
