...
function M.Setup(config)
    ...
    pcall(dse.ecs.add_audio_listener_2d, listener)
    ...
    pcall(dse.ecs.add_audio_spatial_2d, src1)
    pcall(dse.ecs.set_audio_spatial_2d_range, src1, 6.0)
    pcall(dse.ecs.set_audio_spatial_2d_attenuation, src1, 1.5)
    state.src1 = src1
    ...
    pcall(dse.ecs.add_audio_spatial_2d, src2)
    pcall(dse.ecs.set_audio_spatial_2d_range, src2, 5.0)
    pcall(dse.ecs.set_audio_spatial_2d_attenuation, src2, 2.0)
    state.src2 = src2
