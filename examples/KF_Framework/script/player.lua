...
function Player.setup()
    ...
    -- idle ↔ walk ↔ run
    tr("idle", "walk", 0.2, false, 1.0, {{"speed", COND.GREATER, 0.1}})
    tr("walk", "idle", 0.2, false, 1.0, {{"speed", COND.LESS, 0.1}})
    tr("walk", "run",  0.2, false, 1.0, {{"speed", COND.GREATER, 0.7}})
    tr("run",  "walk", 0.2, false, 1.0, {{"speed", COND.LESS, 0.7}})
    -- attack
    tr("idle", "attack1", 0.15, false, 1.0, {{"attack", COND.IF, 0}})
    tr("walk", "attack1", 0.15, false, 1.0, {{"attack", COND.IF, 0}})
    tr("run",  "attack1", 0.15, false, 1.0, {{"attack", COND.IF, 0}})
    tr("attack1", "attack2", 0.1, true, 0.85, {{"attack", COND.IF, 0}})
    tr("attack2", "attack3", 0.1, true, 0.85, {{"attack", COND.IF, 0}})
    tr("attack1", "idle", 0.2, true, 0.95, {})
    tr("attack2", "idle", 0.2, true, 0.95, {})
    tr("attack3", "idle", 0.25, true, 0.95, {})
    -- block
    tr("idle", "block", 0.15, false, 1.0, {{"block", COND.IF, 0}})
    tr("walk", "block", 0.15, false, 1.0, {{"block", COND.IF, 0}})
    tr("block", "block_idle", 0.1, true, 0.9, {})
    tr("block_idle", "idle", 0.2, false, 1.0, {{"blocking", COND.LESS, 0.5}})
    -- jump
    tr("idle", "jump", 0.1, false, 1.0, {{"jump", COND.IF, 0}})
    tr("walk", "jump", 0.1, false, 1.0, {{"jump", COND.IF, 0}})
    tr("run",  "jump", 0.1, false, 1.0, {{"jump", COND.IF, 0}})
    tr("jump", "idle", 0.2, true, 0.9, {})
    -- impact / death
    tr("idle", "impact", 0.1, false, 1.0, {{"damaged", COND.IF, 0}})
    tr("walk", "impact", 0.1, false, 1.0, {{"damaged", COND.IF, 0}})
    tr("run",  "impact", 0.1, false, 1.0, {{"damaged", COND.IF, 0}})
    tr("impact", "idle", 0.2, true, 0.9, {})
    tr("idle",   "death", 0.15, false, 1.0, {{"dead", COND.IF, 0}})
    tr("walk",   "death", 0.15, false, 1.0, {{"dead", COND.IF, 0}})
    tr("run",    "death", 0.15, false, 1.0, {{"dead", COND.IF, 0}})
    tr("impact", "death", 0.15, false, 1.0, {{"dead", COND.IF, 0}})
    -- kick / cast
    tr("idle", "kick", 0.15, false, 1.0, {{"kick", COND.IF, 0}})
    tr("kick", "idle", 0.2, true, 0.9, {})
    tr("idle", "cast", 0.15, false, 1.0, {{"cast", COND.IF, 0}})
    tr("cast", "idle", 0.25, true, 0.95, {})
