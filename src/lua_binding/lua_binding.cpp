...
#include "renderer/animation_2d.h"
#include "renderer/animation_clip_2d.h"
#include "renderer/grid.h"
#include "renderer/tilemap.h"
#include "renderer/tilemap_renderer.h"
#include "renderer/tilemap_collider.h"
...
#include "lighting/light_2d.h"
#include "lighting/light_manager.h"
#include "ui/layout_group.h"
...
//                                      "event_instance",&AudioStudioEvent::event_instance,
    ...
    // component
    {
        ...
        cpp_ns_table.new_usertype<GameObject>("GameObject",sol::call_constructor,sol::constructors<GameObject(const char*)>(),
                                            ...
                                            "SaveScene", &GameObject::SaveScene,
                                            "LoadScene", &GameObject::LoadScene
        );
    ...
    // renderer
    {
        ...
        cpp_ns_table.new_usertype<MeshRenderer>("MeshRenderer",sol::call_constructor,sol::constructors<MeshRenderer()>(),
                                              ...
                                              "set_sorting_layer", &MeshRenderer::set_sorting_layer,
                                              "sorting_layer", &MeshRenderer::sorting_layer,
                                              "set_order_in_layer", &MeshRenderer::set_order_in_layer,
                                              "order_in_layer", &MeshRenderer::order_in_layer
        );
        ...
        cpp_ns_table.new_usertype<Sprite>("Sprite",sol::call_constructor,sol::constructors<Sprite()>(),
                                        "set_texture", &Sprite::set_texture,
                                        "texture", &Sprite::texture,
                                        "set_texture_path", &Sprite::set_texture_path,
                                        "texture_path", &Sprite::texture_path,
                                        "set_rect", &Sprite::set_rect,
                                        "rect", &Sprite::rect,
                                        ...
                                        "CreateFromAtlas", sol::overload(
                                            ...
                                            [] (const std::string& texture_path, float x, float y, float width, float height, float pivot_x, float pivot_y, float ppu) {
                                                return Sprite::CreateFromAtlas(texture_path, x, y, width, height, pivot_x, pivot_y, ppu);
                                            }
                                        )
        );

        cpp_ns_table.new_usertype<SpriteRenderer>("SpriteRenderer",sol::call_constructor,sol::constructors<SpriteRenderer()>(),
                                                sol::base_classes,sol::bases<Component>(),
                                                "set_sprite", &SpriteRenderer::set_sprite,
                                                "sprite", &SpriteRenderer::sprite,
                                                "set_color", &SpriteRenderer::set_color,
                                                "color", &SpriteRenderer::color,
                                                "set_sorting_layer", &SpriteRenderer::set_sorting_layer,
                                                "sorting_layer", &SpriteRenderer::sorting_layer,
                                                "set_order_in_layer", &SpriteRenderer::set_order_in_layer,
                                                "order_in_layer", &SpriteRenderer::order_in_layer
        );

        cpp_ns_table.new_usertype<AnimationClip2D>("AnimationClip2D",sol::call_constructor,sol::constructors<AnimationClip2D()>(),
                                                 "AddFrame", &AnimationClip2D::AddFrame,
                                                 "set_is_looping", &AnimationClip2D::set_is_looping,
                                                 "is_looping", &AnimationClip2D::is_looping,
                                                 "set_name", &AnimationClip2D::set_name,
                                                 "name", &AnimationClip2D::name
        );

        cpp_ns_table.new_usertype<Animation2D>("Animation2D",sol::call_constructor,sol::constructors<Animation2D()>(),
                                             sol::base_classes,sol::bases<Component>(),
                                             "set_clip", &Animation2D::set_clip,
                                             "clip", &Animation2D::clip,
                                             "Play", &Animation2D::Play,
                                             "Stop", &Animation2D::Stop,
                                             "set_is_playing", &Animation2D::set_is_playing,
        ...
        cpp_ns_table.new_usertype<Tilemap>("Tilemap", sol::call_constructor, sol::constructors<Tilemap()>(),
                                         sol::base_classes, sol::bases<Component>(),
                                         "SetTile", &Tilemap::SetTile,
                                         "GetTile", &Tilemap::GetTile,
                                         "ClearAllTiles", &Tilemap::ClearAllTiles,
                                         "SaveToFile", &Tilemap::SaveToFile,
                                         "LoadFromFile", &Tilemap::LoadFromFile
        );

        cpp_ns_table.new_usertype<TilemapRenderer>("TilemapRenderer", sol::call_constructor, sol::constructors<TilemapRenderer()>(),
                                             sol::base_classes, sol::bases<Component>(),
                                             "set_color", &TilemapRenderer::set_color,
                                             "color", &TilemapRenderer::color,
                                             "set_sorting_layer", &TilemapRenderer::set_sorting_layer,
                                             "sorting_layer", &TilemapRenderer::sorting_layer,
                                             "set_order_in_layer", &TilemapRenderer::set_order_in_layer,
                                             "order_in_layer", &TilemapRenderer::order_in_layer
        );
        cpp_ns_table.new_usertype<TilemapCollider>("TilemapCollider", sol::call_constructor, sol::constructors<TilemapCollider()>(),
                                             sol::base_classes, sol::bases<Component>()
        );
    }
    ...
    // physics
    {
        ...
        cpp_ns_table.new_usertype<RigidDynamic>("RigidDynamic", sol::call_constructor, sol::constructors<RigidDynamic()>(),
                                              ...
                                              "set_2d_mode", &RigidDynamic::set_2d_mode,
                                              "is_2d_mode", &RigidDynamic::is_2d_mode
        );
        ...
        // ParticleSystem
        cpp_ns_table.new_usertype<ParticleProps>("ParticleProps",sol::call_constructor,sol::constructors<ParticleProps()>(),
            "Position", &ParticleProps::Position,
            "Velocity", &ParticleProps::Velocity,
            "VelocityVariation", &ParticleProps::VelocityVariation,
            "ColorBegin", &ParticleProps::ColorBegin,
            "ColorEnd", &ParticleProps::ColorEnd,
            "SizeBegin", &ParticleProps::SizeBegin,
            "SizeEnd", &ParticleProps::SizeEnd,
            "SizeVariation", &ParticleProps::SizeVariation,
            "LifeTime", &ParticleProps::LifeTime
        );

        cpp_ns_table.new_usertype<ParticleSystem>("ParticleSystem",sol::call_constructor,sol::constructors<ParticleSystem()>(),
            sol::base_classes,sol::bases<Component>(),
            "Emit", &ParticleSystem::Emit
        );

        // Light2D
        cpp_ns_table.new_usertype<Light2D>("Light2D",sol::call_constructor,sol::constructors<Light2D()>(),
            sol::base_classes,sol::bases<Component>(),
            "SetColor", &Light2D::SetColor,
            "SetIntensity", &Light2D::SetIntensity,
            "SetRange", &Light2D::SetRange
        );

        // LayoutGroup
        cpp_ns_table.new_usertype<LayoutGroup>("LayoutGroup",sol::call_constructor,sol::constructors<LayoutGroup()>(),
            sol::base_classes,sol::bases<Component>(),
            "CalculateLayout", &LayoutGroup::CalculateLayout,
            "SetSpacing", &LayoutGroup::SetSpacing
        );

        // NavMesh
        cpp_ns_table.new_usertype<NavMesh>("NavMesh",sol::call_constructor,sol::constructors<NavMesh()>(),
            sol::base_classes,sol::bases<Component>(),
            "Build", &NavMesh::Build,
            "FindPath", &NavMesh::FindPath
        );

        // Prefab
        cpp_ns_table.new_usertype<Prefab>("Prefab",sol::call_constructor,sol::constructors<Prefab()>(),
        ...
        // AutoTile
        cpp_ns_table.new_usertype<AutoTileRule>("AutoTileRule",sol::call_constructor,sol::constructors<AutoTileRule()>(),
            sol::base_classes,sol::bases<Resource>(),
            "AddRule", &AutoTileRule::AddRule,
            "GetTileIndex", &AutoTileRule::GetTileIndex
        );
        
        cpp_ns_table.new_usertype<AutoTileRule::Rule>("AutoTileRule_Rule",sol::call_constructor,sol::constructors<AutoTileRule::Rule()>(),
            "tile_index", &AutoTileRule::Rule::tile_index
            // Binding array 'neighbors' is tricky in sol2 directly, might need helper or property wrapper
            // For now, we skip neighbors binding or need a wrapper function.
        );
