...
RTTR_REGISTRATION
{
    registration::class_<MeshRenderer>("MeshRenderer")
            ...
            .property("sorting_layer", &MeshRenderer::sorting_layer, &MeshRenderer::set_sorting_layer)
            .property("order_in_layer", &MeshRenderer::order_in_layer, &MeshRenderer::set_order_in_layer);
}
