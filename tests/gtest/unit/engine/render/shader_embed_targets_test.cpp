...
// 核心 PBR：三端主渲染着色器
TEST(ShaderEmbedTargetsTest, PBR三端目标齐备) {
...
TEST(ShaderEmbedTargetsTest, GpuDriven变体三端目标齐备) {
...
// 阴影 / 天空盒 / 精灵
TEST(ShaderEmbedTargetsTest, 阴影天空盒精灵三端目标齐备) {
...
TEST(ShaderEmbedTargetsTest, 后处理三端目标齐备) {
...
TEST(ShaderEmbedTargetsTest, 计算着色器三端目标齐备) {
