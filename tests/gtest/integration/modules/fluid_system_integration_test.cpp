...
TEST_F(FluidSystemIntegrationTest, 初始化不崩溃) {
    system.Init(world, nullptr);
    EXPECT_NO_THROW(system.Shutdown(world));
}

TEST_F(FluidSystemIntegrationTest, 发射粒子) {
...
TEST_F(FluidSystemIntegrationTest, 粒子发射数量与rate成正比) {
    auto e = CreateFluidEmitter();
    system.Init(world, nullptr);
...
TEST_F(FluidSystemIntegrationTest, 粒子在重力下下落) {
    auto e = CreateFluidEmitter();
    system.Init(world, nullptr);
...
TEST_F(FluidSystemIntegrationTest, 地面碰撞_粒子不穿地) {
    auto e = CreateFluidEmitter();
    auto& fluid = world.registry().get<FluidEmitterComponent>(e);
    fluid.floor_y = 0.0f;
...
TEST_F(FluidSystemIntegrationTest, 粒子生命周期_过期移除) {
    auto e = CreateFluidEmitter();
    auto& fluid = world.registry().get<FluidEmitterComponent>(e);
...
TEST_F(FluidSystemIntegrationTest, SPH密度估计_粒子密集时密度大于零) {
    auto e = CreateFluidEmitter();
    auto& fluid = world.registry().get<FluidEmitterComponent>(e);
...
TEST_F(FluidSystemIntegrationTest, 球形发射器_粒子分布在球内) {
...
TEST_F(FluidSystemIntegrationTest, 箱形发射器_粒子分布在箱内) {
...
TEST_F(FluidSystemIntegrationTest, 禁用发射器不发射) {
    auto e = CreateFluidEmitter();
    auto& fluid = world.registry().get<FluidEmitterComponent>(e);
    fluid.enabled = false;
    system.Init(world, nullptr);
...
TEST_F(FluidSystemIntegrationTest, 零dt不崩溃) {
    CreateFluidEmitter();
    system.Init(world, nullptr);
    EXPECT_NO_THROW(system.Update(world, 0.0f));
}

TEST_F(FluidSystemIntegrationTest, 负dt不崩溃) {
    CreateFluidEmitter();
    system.Init(world, nullptr);
