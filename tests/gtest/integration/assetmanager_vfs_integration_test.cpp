 ...
 * @brief AssetManager + VFS (Virtual File System) 集成测试
 *
 * 验证场景：
...
TEST_F(AssetManagerVfsIntegrationTest, ConfigureDataRoot后GetDataRoot返回正确值) {
    asset_mgr.ConfigureDataRoot("data");
...
TEST_F(AssetManagerVfsIntegrationTest, CreateMaterialInstance缓存命中) {
...
TEST_F(AssetManagerVfsIntegrationTest, ListMaterialInstanceIds返回已创建的材质) {
...
TEST_F(AssetManagerVfsIntegrationTest, UnloadUnused释放未引用资源) {
...
TEST_F(AssetManagerVfsIntegrationTest, SetJobSystem后GetJobSystem返回正确指针) {
