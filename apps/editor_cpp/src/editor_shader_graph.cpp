...
std::string CompileGraphVertexGLSL() {
    std::ostringstream o;
    o << "// Auto-generated by DSEngine Shader Graph (vertex)\n";
    o << "#version 430\n\n";
    ...
    o << "out vec2 v_uv;\n";
    o << "out vec3 v_normal;\n";
    o << "out vec3 v_world_pos;\n";
    o << "out vec3 v_tangent;\n";
    o << "out vec3 v_bitangent;\n";
    o << "out vec4 v_color;\n\n";
    o << "void main() {\n";
    o << "    v_world_pos = a_pos;\n";
    o << "    v_normal = a_normal;\n";
...
std::string CompileGraphToGLSL(const ShaderGraphState& s) {
    std::ostringstream o;
    o << "// Auto-generated by DSEngine Shader Graph (fragment)\n";
    // #version 430：与引擎内建 GL 着色器一致，支持 UBO layout(binding=)。仅 OpenGL 后端。
    o << "#version 430\n\n";
    // 顶点着色器（CompileGraphVertexGLSL）输出的 varying，命名/语义与引擎网格顶点契约一致。
    o << "in vec2 v_uv;\n";
    o << "in vec3 v_normal;\n";
