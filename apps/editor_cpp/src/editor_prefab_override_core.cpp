/**
 * @file editor_prefab_override_core.cpp
 * @brief Prefab override 纯逻辑（无 ImGui）：实例 vs .dprefab 源文件 diff、单/全量 revert、
 *        apply-to-prefab。从 editor_prefab_override.cpp 抽出，供无头 gtest 直接链接测试。
 */
