...
void RegisterEntityTools(ControlServer& server, std::vector<std::string>& names) {
    server.RegisterTool("dsengine_scene_get_state", HandleSceneGetState);
    names.push_back("dsengine_scene_get_state");
    server.RegisterTool("dsengine_entity_create", HandleEntityCreate);
    names.push_back("dsengine_entity_create");
    server.RegisterTool("dsengine_entity_delete", HandleEntityDelete);
    names.push_back("dsengine_entity_delete");
    server.RegisterTool("dsengine_entity_batch_delete", HandleEntityBatchDelete);
    names.push_back("dsengine_entity_batch_delete");
    server.RegisterTool("dsengine_entity_modify", HandleEntityModify);
    names.push_back("dsengine_entity_modify");
    server.RegisterTool("dsengine_entity_add_component", HandleEntityAddComponent);
    names.push_back("dsengine_entity_add_component");
    server.RegisterTool("dsengine_entity_remove_component", HandleEntityRemoveComponent);
    names.push_back("dsengine_entity_remove_component");
    server.RegisterTool("dsengine_entity_get_components", HandleEntityGetComponents);
    names.push_back("dsengine_entity_get_components");
    server.RegisterTool("dsengine_entity_get_state", HandleEntityGetState);
    names.push_back("dsengine_entity_get_state");
    server.RegisterTool("dsengine_entity_duplicate", HandleEntityDuplicate);
    names.push_back("dsengine_entity_duplicate");
    server.RegisterTool("dsengine_entity_reparent", HandleEntityReparent);
    names.push_back("dsengine_entity_reparent");
    server.RegisterTool("dsengine_entity_find_by_name", HandleEntityFindByName);
    names.push_back("dsengine_entity_find_by_name");
    server.RegisterTool("dsengine_entity_set_active", HandleEntitySetActive);
    names.push_back("dsengine_entity_set_active");
    server.RegisterTool("dsengine_entity_get_children", HandleEntityGetChildren);
    names.push_back("dsengine_entity_get_children");
}
