...
| 5 | GPU Driven 未启用 | 100-1000x | 全部走 CPU 路径，实验级未稳定 |
...
- GPU Driven 突破（4-6 周）→ 追平 Unity 面数
- 完整 Nanite 虚拟几何体（4-6 个月）→ 追平 UE5 面数
- HWRT + 体积云 + 虚拟纹理 + LWC + GPU Skinning
- **单人全做约 18-24 个月，不推荐单人一步到位**
