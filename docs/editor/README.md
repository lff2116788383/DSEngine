...
- **AI Control Server**：✅ 已完成 — WebSocket JSON-RPC (端口 9527) + MCP adapter，15 个 Tool
- **架构改进**：✅ main.cpp → EditorApp 拆分，✅ Inspector 注册式重构 (29 组件)
- **下一步**：Phase 2 资产生成 Tool (外部 API) 或 EditorContext 统一
