...
9. [dssl — DSSL 材质系统](#9-dssl--dssl-材质系统)
10. [nav — NavMesh 导航系统](#10-nav--navmesh-导航系统)
11. [streaming — 资源流式加载](#11-streaming--资源流式加载)
...
| app / assets / metrics | `lua_binding_core.cpp` | ~25 |
| ecs.core | `lua_binding_ecs_core.cpp` | 4 |
| ecs.transform | `lua_binding_ecs_transform.cpp` | 5 |
| ecs.rendering | `lua_binding_ecs_rendering.cpp` | 94 |
...
| ecs.particles | `lua_binding_ecs_particles.cpp` | ~17 |
