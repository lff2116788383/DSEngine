...
function GameObject.SaveScene(file_path)
    return Cpp.GameObject.SaveScene(file_path)
end

function GameObject.LoadScene(file_path)
    return Cpp.GameObject.LoadScene(file_path)
end
