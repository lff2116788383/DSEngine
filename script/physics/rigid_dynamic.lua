...
function RigidDynamic:set_2d_mode(enable)
    self.cpp_component_instance_:set_2d_mode(enable)
end

function RigidDynamic:is_2d_mode()
    return self.cpp_component_instance_:is_2d_mode()
end