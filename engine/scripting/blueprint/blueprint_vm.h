...
enum class OpCode : uint8_t {
    Nop = 0,
    LoadConst, LoadVar, StoreVar, Move,
    Add, Sub, Mul, Div, Neg, Mod,
    CmpEq, CmpLt, CmpLe,
    And, Or, Not,
    Jump, JumpIfFalse, JumpIfTrue,
    Call, Return,
    Sin, Cos, Sqrt, Abs, Min, Max, Clamp,
    Vec3Add, Vec3Sub, Vec3Scale, Vec3Dot, Vec3Normalize,
    EcsGetFloat, EcsSetFloat, EcsGetVec3, EcsSetVec3,
    CallExtern,
    Concat,
    Print,
    ArrayGet, ArraySet, ArrayLen, ArrayPush,
    Halt,
};
