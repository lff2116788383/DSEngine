...
typedef enum KeyCode{
    ...
    GAMEPAD_BUTTON_A=400,
    GAMEPAD_BUTTON_B=401,
    GAMEPAD_BUTTON_X=402,
    GAMEPAD_BUTTON_Y=403,
    GAMEPAD_BUTTON_LEFT_BUMPER=404,
    GAMEPAD_BUTTON_RIGHT_BUMPER=405,
    GAMEPAD_BUTTON_BACK=406,
    GAMEPAD_BUTTON_START=407,
    GAMEPAD_BUTTON_LEFT_THUMB=408,
    GAMEPAD_BUTTON_RIGHT_THUMB=409,
    GAMEPAD_BUTTON_DPAD_UP=410,
    GAMEPAD_BUTTON_DPAD_RIGHT=411,
    GAMEPAD_BUTTON_DPAD_DOWN=412,
    GAMEPAD_BUTTON_DPAD_LEFT=413,
    GAMEPAD_BUTTON_GUIDE=414,
    GAMEPAD_BUTTON_LAST=GAMEPAD_BUTTON_GUIDE
}KeyCode;
