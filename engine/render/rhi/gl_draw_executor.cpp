...
void GLDrawExecutor::DrawPostProcess(const dse::render::PostProcessRequest& request,
    ...
    // 参数通过 std140 uniform block (binding=2) 或 plain struct uniform 传递。
    {
        ...
        if (gen_shader != 0) {
            ...
            // gen.h: screenTexture — binding=1 for most effects, binding=0 for light_shaft
            if (effect_name == "light_shaft") {
                glActiveTexture(GL_TEXTURE0);
            } else {
                glActiveTexture(GL_TEXTURE1);
            }
            ...
            if (effect_name == "fxaa" && params.size() >= 2) {
                ...
                if (ae_tex_id != 0) {
                    ...
                    glUniform1i(glGetUniformLocation(gen_shader, "_68.u_auto_exposure_enabled"), 1);
                } else {
                    glUniform1i(glGetUniformLocation(gen_shader, "_68.u_auto_exposure_enabled"), 0);
                }
                if (params.size() >= 4 && static_cast<unsigned int>(params[2]) != 0) {
                    glActiveTexture(GL_TEXTURE5);
                    glBindTexture(GL_TEXTURE_3D, static_cast<unsigned int>(params[2]));
                    glUniform1f(glGetUniformLocation(gen_shader, "_68.u_lut_intensity"), params[3]);
                    glUniform1i(glGetUniformLocation(gen_shader, "_68.u_lut_enabled"), 1);
                } else {
                    glUniform1i(glGetUniformLocation(gen_shader, "_68.u_lut_enabled"), 0);
                }
                ...
                glUniform1f(glGetUniformLocation(gen_shader, "_79.exposure"), params[1]);
                if (params.size() >= 3 && static_cast<unsigned int>(params[2]) != 0) {
                    glActiveTexture(GL_TEXTURE3);
                    glBindTexture(GL_TEXTURE_2D, static_cast<unsigned int>(params[2]));
                    glUniform1i(glGetUniformLocation(gen_shader, "_79.autoExposureEnabled"), 1);
                } else {
                    glUniform1i(glGetUniformLocation(gen_shader, "_79.autoExposureEnabled"), 0);
                }
                if (params.size() >= 5 && static_cast<unsigned int>(params[3]) != 0) {
                    glActiveTexture(GL_TEXTURE5);
                    glBindTexture(GL_TEXTURE_3D, static_cast<unsigned int>(params[3]));
                    glUniform1f(glGetUniformLocation(gen_shader, "_79.lutIntensity"), params[4]);
                    glUniform1i(glGetUniformLocation(gen_shader, "_79.lutEnabled"), 1);
                } else {
                    glUniform1i(glGetUniformLocation(gen_shader, "_79.lutEnabled"), 0);
                }
                ...
                glUniform1f(glGetUniformLocation(gen_shader, "_36.u_blend_factor"), params[1]);
                glUniform1f(glGetUniformLocation(gen_shader, "_36.u_jitter_x"), params[2]);
                glUniform1f(glGetUniformLocation(gen_shader, "_36.u_jitter_y"), params[3]);
                glUniform1i(glGetUniformLocation(gen_shader, "_36.u_frame_index"), static_cast<int>(params[4]));
                glUniform1f(glGetUniformLocation(gen_shader, "_36.u_screen_w"), params[6]);
                glUniform1f(glGetUniformLocation(gen_shader, "_36.u_screen_h"), params[7]);
                glActiveTexture(GL_TEXTURE2);
                ...
                glUniform3f(glGetUniformLocation(gen_shader, "_58.u_light_dir"), params[2], params[3], params[4]);
                glUniform1f(glGetUniformLocation(gen_shader, "_58.u_light_intensity"), params[8]);
                glUniform3f(glGetUniformLocation(gen_shader, "_58.u_light_color"), params[5], params[6], params[7]);
                glUniform1f(glGetUniformLocation(gen_shader, "_58.u_ambient"), params[9]);
            } else if (effect_name == "light_shaft" && params.size() >= 12) {
                // plain struct LightShaftParams _25
                // samplers: screenTexture(0), u_depth_tex(2)
                glActiveTexture(GL_TEXTURE2);
                glBindTexture(GL_TEXTURE_2D, static_cast<unsigned int>(params[0]));
                glUniform1f(glGetUniformLocation(gen_shader, "_25.u_depth_handle"), params[0]);
                glUniform1f(glGetUniformLocation(gen_shader, "_25.u_sun_x"), params[1]);
                glUniform1f(glGetUniformLocation(gen_shader, "_25.u_sun_y"), params[2]);
                glUniform1f(glGetUniformLocation(gen_shader, "_25.u_light_r"), params[3]);
                glUniform1f(glGetUniformLocation(gen_shader, "_25.u_light_g"), params[4]);
                glUniform1f(glGetUniformLocation(gen_shader, "_25.u_light_b"), params[5]);
                glUniform1f(glGetUniformLocation(gen_shader, "_25.u_density"), params[6]);
                glUniform1f(glGetUniformLocation(gen_shader, "_25.u_weight"), params[7]);
                glUniform1f(glGetUniformLocation(gen_shader, "_25.u_decay"), params[8]);
                glUniform1f(glGetUniformLocation(gen_shader, "_25.u_exposure"), params[9]);
                glUniform1f(glGetUniformLocation(gen_shader, "_25.u_num_samples"), params[10]);
                glUniform1f(glGetUniformLocation(gen_shader, "_25.u_intensity"), params[11]);
                ...
                glActiveTexture(GL_TEXTURE2);
                glBindTexture(GL_TEXTURE_2D, static_cast<unsigned int>(params[0]));
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_depth_handle"), params[0]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_fog_r"), params[1]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_fog_g"), params[2]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_fog_b"), params[3]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_fog_density"), params[4]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_height_falloff"), params[5]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_height_offset"), params[6]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_fog_start"), params[7]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_fog_end"), params[8]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_fog_steps"), params[9]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_sun_scatter"), params[10]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_sun_dir_x"), params[11]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_sun_dir_y"), params[12]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_sun_dir_z"), params[13]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_cam_pos_x"), params[14]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_cam_pos_y"), params[15]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_cam_pos_z"), params[16]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_near"), params[17]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_far"), params[18]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_right_x"), params[19]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_right_y"), params[20]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_right_z"), params[21]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_up_x"), params[22]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_up_y"), params[23]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_up_z"), params[24]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_fwd_x"), params[25]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_fwd_y"), params[26]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_fwd_z"), params[27]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_tan_fov_y"), params[28]);
                glUniform1f(glGetUniformLocation(gen_shader, "_20.u_aspect"), params[29]);
                ...
                glActiveTexture(GL_TEXTURE2);
                glBindTexture(GL_TEXTURE_2D, static_cast<unsigned int>(params[0]));
                glUniform1f(glGetUniformLocation(gen_shader, "_34.u_dt"), params[1]);
                glUniform1f(glGetUniformLocation(gen_shader, "_34.u_speed_up"), params[2]);
                glUniform1f(glGetUniformLocation(gen_shader, "_34.u_speed_down"), params[3]);
                glUniform1f(glGetUniformLocation(gen_shader, "_34.u_min_exposure"), params[4]);
                glUniform1f(glGetUniformLocation(gen_shader, "_34.u_max_exposure"), params[5]);
                glUniform1f(glGetUniformLocation(gen_shader, "_34.u_compensation"), params[6]);
            } else if (effect_name == "wboit_composite" && params.size() >= 1) {
                // plain struct WboitParams _61, samplers: screenTexture(1), u_reveal_tex(2)
                glActiveTexture(GL_TEXTURE2);
                glBindTexture(GL_TEXTURE_2D, static_cast<unsigned int>(params[0]));
                glUniform1f(glGetUniformLocation(gen_shader, "_61.u_reveal_handle"), params[0]);
                ...
                glActiveTexture(GL_TEXTURE3);
                glBindTexture(GL_TEXTURE_2D, static_cast<unsigned int>(params[1]));
                glUniform1f(glGetUniformLocation(gen_shader, "_35.u_depth_handle"), params[0]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.u_decal_handle"), params[1]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m00"), params[2]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m01"), params[3]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m02"), params[4]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m03"), params[5]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m10"), params[6]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m11"), params[7]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m12"), params[8]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m13"), params[9]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m20"), params[10]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m21"), params[11]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m22"), params[12]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m23"), params[13]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m30"), params[14]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m31"), params[15]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m32"), params[16]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.m33"), params[17]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.u_color_r"), params[18]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.u_color_g"), params[19]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.u_color_b"), params[20]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.u_color_a"), params[21]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.u_angle_fade"), params[22]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.u_decal_up_x"), params[23]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.u_decal_up_y"), params[24]);
                glUniform1f(glGetUniformLocation(gen_shader, "_35.u_decal_up_z"), params[25]);
            } else if (effect_name == "water" && params.size() >= 40) {
                // plain struct WaterParams _29
                // samplers: screenTexture(1), u_depth_tex(2)
                glActiveTexture(GL_TEXTURE2);
                glBindTexture(GL_TEXTURE_2D, static_cast<unsigned int>(params[0]));
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_depth_handle"), params[0]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_water_level"), params[1]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_deep_r"), params[2]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_deep_g"), params[3]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_deep_b"), params[4]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_shallow_r"), params[5]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_shallow_g"), params[6]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_shallow_b"), params[7]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_max_depth"), params[8]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_transparency"), params[9]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_wave_amplitude"), params[10]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_wave_frequency"), params[11]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_wave_speed"), params[12]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_wave_dir_x"), params[13]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_wave_dir_y"), params[14]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_refraction_strength"), params[15]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_specular_power"), params[16]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_reflection_strength"), params[17]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_time"), params[18]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_sun_dir_x"), params[19]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_sun_dir_y"), params[20]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_sun_dir_z"), params[21]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_cam_pos_x"), params[22]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_cam_pos_y"), params[23]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_cam_pos_z"), params[24]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_near"), params[25]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_far"), params[26]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_fwd_x"), params[27]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_fwd_y"), params[28]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_fwd_z"), params[29]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_tan_fov_y"), params[30]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_aspect"), params[31]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_caustic_intensity"), params[32]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_caustic_scale"), params[33]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_foam_intensity"), params[34]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_foam_depth_threshold"), params[35]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_uw_fog_density"), params[36]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_uw_fog_r"), params[37]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_uw_fog_g"), params[38]);
                glUniform1f(glGetUniformLocation(gen_shader, "_29.u_uw_fog_b"), params[39]);
    ...
    if (effect_name == "bloom_extract" && params.size() >= 1) {
        ...
        glUniform2f(glGetUniformLocation(shader, "u_sun_screen"), params[1], params[2]);
        glUniform3f(glGetUniformLocation(shader, "u_light_color"), params[3], params[4], params[5]);
        glUniform1f(glGetUniformLocation(shader, "u_density"), params[6]);
        glUniform1f(glGetUniformLocation(shader, "u_weight"), params[7]);
        glUniform1f(glGetUniformLocation(shader, "u_decay"), params[8]);
        glUniform1f(glGetUniformLocation(shader, "u_exposure"), params[9]);
        glUniform1f(glGetUniformLocation(shader, "u_num_samples"), params[10]);
        glUniform1f(glGetUniformLocation(shader, "u_intensity"), params[11]);
    } else if (effect_name == "edge_detect" && params.size() >= 10) {
        ...
        glUniform1f(glGetUniformLocation(shader, "u_caustic_intensity"), params[32]);
        glUniform1f(glGetUniformLocation(shader, "u_caustic_scale"), params[33]);
        glUniform1f(glGetUniformLocation(shader, "u_foam_intensity"), params[34]);
        glUniform1f(glGetUniformLocation(shader, "u_foam_depth_threshold"), params[35]);
        glUniform1f(glGetUniformLocation(shader, "u_uw_fog_density"), params[36]);
        glUniform3f(glGetUniformLocation(shader, "u_uw_fog_color"), params[37], params[38], params[39]);
    } else if (effect_name == "decal" && params.size() >= 26) {
        glActiveTexture(GL_TEXTURE1);
        glBindTexture(GL_TEXTURE_2D, static_cast<unsigned int>(params[0]));
        glUniform1i(glGetUniformLocation(shader, "u_depth_tex"), 1);
